...
import club.p6e.cloud.auth.generator.StateOtherLoginGenerator;
import club.p6e.cloud.auth.repository.UserAuthRepository;
import club.p6e.cloud.auth.repository.UserRepository;
import club.p6e.cloud.auth.utils.HttpUtil;
import club.p6e.cloud.auth.utils.JsonUtil;
import club.p6e.cloud.auth.utils.TemplateParser;
...
import club.p6e.cloud.auth.generator.RegisterOtherLoginGenerator;
