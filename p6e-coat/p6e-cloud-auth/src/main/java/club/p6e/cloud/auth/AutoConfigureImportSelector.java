...
import club.p6e.cloud.auth.cache.memory.*;
import club.p6e.cloud.auth.cache.redis.*;
import club.p6e.cloud.auth.controller.*;
import club.p6e.cloud.auth.generator.*;
import club.p6e.cloud.auth.service.*;
...
import club.p6e.cloud.auth.codec.AccountPasswordLoginTransmissionCodecImpl;
import club.p6e.coat.gateway.auth.controller.*;
import club.p6e.coat.gateway.auth.generator.*;
import club.p6e.cloud.auth.launcher.EmailMessageLauncherImpl;
import club.p6e.cloud.auth.launcher.SmsMessageLauncherImpl;
import club.p6e.cloud.auth.repository.Oauth2ClientRepository;
import club.p6e.cloud.auth.repository.UserAuthRepository;
import club.p6e.cloud.auth.repository.UserRepository;
import club.p6e.coat.gateway.auth.service.*;
import club.p6e.cloud.auth.validator.AccountPasswordLoginParameterValidator;
