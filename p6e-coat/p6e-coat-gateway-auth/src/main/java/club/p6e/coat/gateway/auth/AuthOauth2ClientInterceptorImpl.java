 ...
 */
@Component
public class AuthOauth2ClientInterceptorImpl implements AuthOauth2ClientInterceptor {
     ...
     * 认证缓存的对象
     */
    protected final Oauth2TokenClientAuthCache cache;

    public AuthOauth2ClientInterceptorImpl(Oauth2TokenClientAuthCache cache) {
        this.cache = cache;
    }
