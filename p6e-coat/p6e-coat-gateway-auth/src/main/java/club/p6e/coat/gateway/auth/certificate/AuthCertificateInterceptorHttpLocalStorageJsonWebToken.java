...
import club.p6e.coat.gateway.auth.AuthJsonWebToken;
...
public class AuthCertificateInterceptorHttpLocalStorageJsonWebToken implements AuthCertificateInterceptor {
     ...
     * 认证缓存的对象
     */
    protected final AuthJsonWebToken jwt;
     ...
     * @param jwt JWT 对象
     */
    public AuthCertificateInterceptorHttpLocalStorageJsonWebToken(AuthJsonWebToken jwt) {
        this.jwt = jwt;
    }
