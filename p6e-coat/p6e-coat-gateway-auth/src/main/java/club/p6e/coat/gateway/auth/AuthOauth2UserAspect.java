...
@Aspect
@Component
public class AuthOauth2UserAspect {

    private final AuthOauth2UserInterceptor interceptor;

    public AuthOauth2UserAspect(AuthOauth2UserInterceptor interceptor) {
        this.interceptor = interceptor;
    }

    @Pointcut("@annotation(club.p6e.coat.gateway.auth.AuthOauth2User))")
