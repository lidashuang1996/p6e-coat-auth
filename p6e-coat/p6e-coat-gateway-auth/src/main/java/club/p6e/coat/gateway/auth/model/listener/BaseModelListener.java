package club.p6e.coat.gateway.auth.model.listener;

import com.darvi.smart.construction.lib.AuthCore;
import com.darvi.smart.construction.web.infrastructure.model.*;
...
public class BaseModelListener {
    ...
    private static final Class<?>[] MS = new Class<?>[]{
            ...
            AlertModel.class,
            AlertActionModel.class,
            AlertActionResourceModel.class,
            SpotModel.class
    };
